...
public class CsvToDBConfig {
	...
	public FlatFileItemReader < PaymtTransaction > csvTransactionReader() throws IOException {
		    ...
		    reader.setResource(new FileSystemResource("C:\\Users\\Lenovo\\Desktop\\trfile.csv"));
	...
	public JdbcBatchItemWriter<PaymtTransaction> csvTransactionWriter() {
		 ...
		 csvTransactionWriter.setSql("INSERT INTO transactions (ref,date,payerName,payerAccNo,payeeName,payeeAccNo,amount) VALUES (:ref,:date,:payerName,:payerAccNo,:payeeName,:payeeAccNo,:amount)");
