...
import com.cbp.sanctions.controller.Controller;
...
public class FileUploadService {
	...
	public ResponseEntity<String> uploadData(MultipartFile file) throws Exception {
		...
		{
			return new ResponseEntity<String>(AppConstants.UNSUCCESSFUL, HttpStatus.OK);
		}
        ...
        /*JobExecution jobExecution = jobLauncher.run(csvFileToDatabaseJob, new JobParametersBuilder()
                ...
                .toJobParameters());   */ 
		return new ResponseEntity<String>(AppConstants.SUCCESSFUL, HttpStatus.OK);
	}
}
